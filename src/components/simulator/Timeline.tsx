...
export function Timeline({
  ...
  return (
    <section className="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur">
      ...
      <div className="relative mt-6 space-y-4 before:absolute before:bottom-4 before:left-[11px] before:top-4 before:w-px before:bg-gradient-to-b before:from-cyan-300 before:to-slate-200">
        {events.map((event) => (
